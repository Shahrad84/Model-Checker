...
public interface HashListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link HashParser#comparison}.
	 * @param ctx the parse tree
	 */
	void enterComparison(HashParser.ComparisonContext ctx);
	/**
	 * Exit a parse tree produced by {@link HashParser#comparison}.
	 * @param ctx the parse tree
	 */
	void exitComparison(HashParser.ComparisonContext ctx);
	/**
	 * Enter a parse tree produced by {@link HashParser#addition}.
	 * @param ctx the parse tree
	 */
	void enterAddition(HashParser.AdditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link HashParser#addition}.
	 * @param ctx the parse tree
	 */
	void exitAddition(HashParser.AdditionContext ctx);
	/**
	 * Enter a parse tree produced by {@link HashParser#multiplication}.
	 * @param ctx the parse tree
	 */
	void enterMultiplication(HashParser.MultiplicationContext ctx);
	/**
	 * Exit a parse tree produced by {@link HashParser#multiplication}.
	 * @param ctx the parse tree
	 */
	void exitMultiplication(HashParser.MultiplicationContext ctx);
	/**
