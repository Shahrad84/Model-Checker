...
public interface HashVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link HashParser#comparison}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComparison(HashParser.ComparisonContext ctx);
	/**
	 * Visit a parse tree produced by {@link HashParser#addition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAddition(HashParser.AdditionContext ctx);
	/**
	 * Visit a parse tree produced by {@link HashParser#multiplication}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMultiplication(HashParser.MultiplicationContext ctx);
	/**
